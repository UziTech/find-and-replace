...
class FindView {
  ...
  handleEvents() {
    ...
    this.refs.nextButton.addEventListener('click', (e) => !atom.config.get('find-and-replace.findReplacePrevButton') && e.shiftKey ? this.findPrevious({focusEditorAfter: true}) : this.findNext({focusEditorAfter: true}));
    ...
    this.refs.replaceNextButton.addEventListener('click', (e) => !atom.config.get('find-and-replace.findReplacePrevButton') && e.shiftKey ? this.replacePrevious() : this.replaceNext());
    ...
    this.subscriptions.add(atom.config.onDidChange('find-and-replace.findReplacePrevButton', () => {
      this.updateButtons()
    }))
  ...
  updateButtons() {
    const prevButtons = atom.config.get('find-and-replace.findReplacePrevButton');
