...
class ResultsPaneView {
  constructor() {
    ...
    this.subscriptions = new CompositeDisposable(
      ...
      atom.config.observe('temp-find-and-replace.searchContextLineCountBefore', this.searchContextLineCountChanged.bind(this)),
      atom.config.observe('temp-find-and-replace.searchContextLineCountAfter', this.searchContextLineCountChanged.bind(this))
    );
  }
  ...
  searchContextLineCountChanged() {
    this.searchContextLineCountBefore = atom.config.get('temp-find-and-replace.searchContextLineCountBefore');
    this.searchContextLineCountAfter = atom.config.get('temp-find-and-replace.searchContextLineCountAfter');
