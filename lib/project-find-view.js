...
class ProjectFindView {
  ...
  handleEvents() {
    ...
    let afterSearch = () => {
      if (atom.config.get('temp-find-and-replace.closeFindPanelAfterSearch')) {
  ...
  showResultPane() {
    ...
    let openDirection = atom.config.get('temp-find-and-replace.projectSearchResultsPaneSplitDirection');
